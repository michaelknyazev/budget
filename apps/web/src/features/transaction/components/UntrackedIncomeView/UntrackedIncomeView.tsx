...
import styles from './UntrackedIncomeView.module.scss';
  ...
  if (isLoading) {
    return (
      <div className={styles.container}>
        <PageHeader title="Untracked Income" />
  ...
  return (
    <div className={styles.container}>
      ...
      {transactions.length === 0 ? (
        <NonIdealState
          icon="tick-circle"
          title="All income is tracked"
          description="Every income transaction for this period is linked to a planned income source."
        />
      ) : (
